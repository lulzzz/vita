...
namespace Vita.Domain.Infrastructure
{
  ...
  public static class DateTimeUtil
  {
    ...
    public static bool TryParseDateTime(this string str, DateTimeFormat defaultFormat, out DateTime date_time)
    {
      ...
      date_time = parsedDateTime.DateTime;
      return true;
    }
    ...
    public static bool TryParseDateOrTime(this string str, DateTimeFormat defaultFormat, out DateTime date_time)
    {
    ...
    {
      if (!TryParseDate(str, default_format, out ParsedDateTime parsedDate))
      {
    ...
    /// <returns>true if both date and time were found, else false</returns>
    public static bool TryParseDateTime(this string str, DateTimeFormat default_format,
      out ParsedDateTime parsedDateTime)
    {
      if (str.TryParseDateOrTime(default_format, out parsedDateTime)
    ...
    public static bool TryParseDateOrTime(this string str, DateTimeFormat default_format,
      out ParsedDateTime parsed_date_time)
    {
      ...
      if (!TryParseDate(str, default_format, out parsed_date))
      {
        ...
        var date_time = new DateTime(DefaultDate.Year, DefaultDate.Month, DefaultDate.Day, parsed_time.DateTime.Hour,
        ...
        parsed_date_time = new ParsedDateTime(-1, -1, parsed_time.IndexOfTime, parsed_time.LengthOfTime, date_time,
          parsed_time.UtcOffset);
      }
      else
      {
        if (!TryParseTime(str, default_format, out parsed_time, parsed_date))
        {
          var date_time = new DateTime(parsed_date.DateTime.Year, parsed_date.DateTime.Month, parsed_date.DateTime.Day,
            0, 0, 0);
      ...
      ParsedDateTime parsed_date)
    {
      ...
      string time_zone_r;
      if (default_format == DateTimeFormat.UsaDate)
      ...
      if (parsed_date != null && parsed_date.IndexOfDate > -1)
      {
        ...
        if (!m.Success)
          ...
          m = Regex.Match(str.Substring(0, parsed_date.IndexOfDate),
            ...
            time_zone_r + @"(?=$|[\s,]+)", RegexOptions.Compiled);
        if (!m.Success)
    ...
    public static bool TryParseDate(this string str, DateTimeFormat default_format, out ParsedDateTime parsed_date)
    {
      ...
      {
        DateTime date;
        if ((default_format ^ DateTimeFormat.UsaDate) == DateTimeFormat.UsaDate)
        {
