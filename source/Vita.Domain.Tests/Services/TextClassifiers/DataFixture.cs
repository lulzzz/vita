...
namespace Vita.Domain.Tests.Services.TextClassifiers
{
  public class DataFixture
  {
    ...
    private void LoadKeywordClassifiers()
    {
      ...
      data.Single(x=>x.SubCategory == Categories.HealthBeauty.DoctorsDentist).AddKeyword(CompanyNames.StJohnOfGod.ToLowerInvariant());
      data.Single(x => x.SubCategory == Categories.Kids.Childcare).AddKeyword(CompanyNames.Kidz.ToLowerInvariant());
    }
